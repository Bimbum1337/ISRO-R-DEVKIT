...
private:
	CIFStatic* m_pGDR_PI_TEXT_LEVEL; //0x0374
...
private:
    BEGIN_FIXTURE()
        ENSURE_SIZE(0x3E4)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_LEVEL, 0x0374)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_CURXP2, 0x0378)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_NEXTXP2, 0x037C)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_STAT2, 0x0380)
        ENSURE_OFFSET(m_pGDR_PI_HONOR_DATA, 0x0384)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_HONOR_STATIC, 0x0388)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_HP_DAT, 0x038C)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_STRENGTH_DAT, 0x0390)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_MP_DAT, 0x0394)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_INTELLECT_DAT, 0x0398)
        ENSURE_OFFSET(m_pGDR_PI_BTN_ADDMP, 0x039C)
        ENSURE_OFFSET(m_pGDR_PI_BTN_ADDHP, 0x03A0)
        ENSURE_OFFSET(m_pGDR_PI_GAUGE_HPGAUGE, 0x03A4)
        ENSURE_OFFSET(m_pGDR_PI_GAUGE_MPGAUGE, 0x03A8)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_PHYATT_DAT, 0x03AC)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_PHYDEF_DAT, 0x03B0)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_PHYBAL_DAT, 0x03B4)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_HIT_DAT, 0x03B8)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_MAGATT_DAT, 0x03BC)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_MAGDEF_DAT, 0x03C0)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_MAGBAL_DAT, 0x03C4)
        ENSURE_OFFSET(m_pGDR_PI_TEXT_PARRY_DAT, 0x03C8)
        ENSURE_OFFSET(m_pGDR_PI_JOB_ALIAS, 0x03CC)
        ENSURE_OFFSET(m_pGDR_PI_JOB_ICON, 0x03D0)
        ENSURE_OFFSET(m_pGDR_PI_JOB_TITLE, 0x03D4)
        ENSURE_OFFSET(m_pGDR_PI_JOB_GRADE, 0x03D8)
        ENSURE_OFFSET(m_pGDR_PI_JOB_EXP, 0x03DC)
        ENSURE_OFFSET(m_pGDR_PI_JOB_EXP_GAUGE, 0x03E0)
    END_FIXTURE()
